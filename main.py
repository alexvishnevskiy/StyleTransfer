...
def send_prediction_on_photo(update, context):
    ...
    if update.message.text == '/style':
        storage.append('1')
        update.message.reply_text("Пришли 2 фотографии, первая фотография - то, что хочешь изменить. Вторая - стиль, который хочешь получить (любая картина художника).")
    ...
    if update.message.text == '/photo_real':
        storage1.append('1')
        update.message.reply_text("Пришли 2 фотографии, первая фотография - пейзаж. Вторая - стиль, который хочешь перенести на свою фотографию.")
...
def start(update, context):
    ...
    update.message.reply_text(
        'Привет, это бот, который меняет стиль Вашего изображения на любой другой по Вашему желанию. Если хотите превратить свою фотографию в картину нажмите /style, если хотите перенести стиль одного фото на другое нажмите /photo_real. Пришлите /cancel, чтобы перестать со мной общаться.',
...
if __name__ == '__main__':
    ...
    updater = Updater(token='808687119:AAFa1IUjO7mIyqgdDKHwjbCJZ4e04Z85XjU' , request_kwargs={'proxy_url': 'socks5h://163.172.152.192:1080'},
                      use_context=True)
